...
- [ ] Reliable locations and anchored highlights; precise passage search navigation.
- [ ] Footnote previews, dictionary lookup, annotation export and source backlinks.
- [ ] Manga fit modes, page overview, series preferences, next-volume continuation, bounded prefetch.
- [ ] Webtoon long-image handling; border crop and wide-page splitting.
- [ ] PDF outline, thumbnails, text search/selection, annotations and crop.
...
- [ ] MCP confidence/provenance review queue and reusable accepted organization rules.
